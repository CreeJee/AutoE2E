...
export const hasInstance = (classConstructor) => classConstructor[Symbol.hasInstance] || ((v) => v instanceof classConstructor) ;
...
export class Flow{
    ...
    add (cond: Cond, ...handlers: FlowHandlers) {
        ...
        if (flow.has(cond)) {
            ...
            // if actually work i'll merge flow;
        }
